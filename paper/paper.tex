...
candidates , researchers have used strategies such as random search \gl{Should
  ...
  work ?}, meta-gradient descent ~\cite{Pedregosa2016} , gaussian processes
~\cite{Bergstra2011a}, and Parzen Estimators ~\cite{Bergstra2011a} to reduce
find good parameters without exhaustively exploring the entire hyper-parameter
space. Although these strategies help with finding a good set of
hyper-parameters, they still require a compute-intensive search of the space.
