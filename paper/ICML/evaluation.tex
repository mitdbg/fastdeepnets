...
Our second dataset we will evaluate on is \texttt{COVERTYPE} [ref]. \gl{TODO
  rephrase the description taken from the UCI website} We picked
...
\gl{Todo for me: explain how I select the best epoch to get rid of the outliers}

\subsection{Intepretation of the result of random search}

\gl{TODO draw conclusions from the plots}:
\begin{itemize}
...
($1$ input) and large batch sizes (depend on the dataset and hardware).
