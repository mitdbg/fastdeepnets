...
To solve this task we use the \texttt{VGG16} model \cite{Srivastava2014}. It is constituted of
...
\textit{Dropout} \cite{Srivastava2014} nor \textit{BatchNorm} \cite{DBLP:journals/corr/IoffeS15}. \gl{Should we say here that we
...
experimentations on simpler datasets like \texttt{MNIST} \cite{Lecun1998} and
\texttt{FashionMNIST} \cite{Xiao2017} we observed that even if they have the same number of
