...
\gl{Add another paragraph on architectures that are small by design ? (MobileNet
ShuffleNet)}
...
\paragraph{Dynamically Sizing Networks}The techniques closest to our
...
\gl{say that they don't do neural garbage collection ?}.
